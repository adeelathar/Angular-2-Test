    ...
    $.infinitescroll.prototype = {
        ...
        _determinepath: function infscr_determinepath(path) {
            ...
            if (!!opts.pathParse) {
                ...
                if (path.match(/^(.*?page=)1(\/.*|$)/)) {
                    ...
                    this._debug('Sorry, we couldn\'t parse your Next (Previous images) URL. Verify your the css selector points to the correct A tag. If you still get this error: yell, scream, and kindly ask for help at infinite-scroll.com.');
        ...
        _loadcallback: function infscr_loadcallback(box, data) {
            ...
            if (opts.animate) {
				...
				$('#infscr-loading div').css.css({"transition":"none","bottom":"0px","transform":"translate(0px,0px)"});
                $('html,body').animate({
                    scrollTop: scrollTo
                }, 800, function () {
